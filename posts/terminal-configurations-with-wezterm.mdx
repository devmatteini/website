...
In the last few months I've been trying to improve the automation of terminal configuration for my work/personal projects.
...
So my journey to automate terminal configurations begun!
...
{/* TODO: set img to use NextJs image component */}
This is the result: ![website zellij layout](/blog/terminal-configurations-with-wezterm/website-zellij.webp)
...
![WezTerm website terminal configuration](/blog/terminal-configurations-with-wezterm/wezterm-website.webp)
...
Next, we need to create the `base_dir` directory and then we can create a file inside it called `website.lua`:
...
-   [wezterm.lua](https://github.com/devmatteini/dotfiles/blob/e05024cf7c2f5a60887f7393106b6bf974d55368/config/wezterm/wezterm.lua)
-   [project.lua](https://github.com/devmatteini/dotfiles/blob/e05024cf7c2f5a60887f7393106b6bf974d55368/config/wezterm/project.lua)
