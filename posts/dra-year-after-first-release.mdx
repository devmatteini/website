...
<br />
The platform that downloaded the most `dra` was Linux with 491 downloads (x86_64 and arm).

For the time being, it seems that fewer users are interested on macOS and Windows versions (11 downloads combined).

On the other hand, Linux arm versions have 18 downloads combined with just one release!
