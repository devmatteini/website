...
Effect leverage the type system to make things explicit: errors and requirements. Although we only covered the requirements part, you should check out [error handling](https://www.effect.website/docs/error-management/two-error-types).
